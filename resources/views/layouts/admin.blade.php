...
<head>
    <meta charset="utf-8" />
    <title>Crypto Casino Games - The 15 Best Bitcoin Gambling Game</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />

    <link rel="shortcut icon" href="{{ asset('/img/logo/logo_black.svg') }}">
    ...
    <div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
        <div class="container-fluid">
            <a href="/admin" class="navbar-brand mr-0 mr-md-2 logo">
                <span class="logo-lg">
                    <img src="{{ asset('/img/logo/logo_black.svg') }}" alt="" height="24" />
                </span>
                <span class="logo-sm">
                    <img src="{{ asset('/img/logo/logo_black.svg') }}" alt="" height="24">
                </span>

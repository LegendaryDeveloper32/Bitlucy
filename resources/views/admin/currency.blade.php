    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2 font-weight-bold font-size-16">Send funds from user personal deposit wallet to global deposit address if node was offline</div>
                        <div class="row">
                            <div class="col-12 col-lg-2">
                                <select class="form-control" id="b_currency">
                                    @foreach(\App\Currency\Currency::all() as $currency)
                                        <option value="{{ $currency->id() }}">{{ $currency->name() }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-8 mt-2 mt-lg-0">
                                <input class="form-control" id="b_address" placeholder="User ID">
                                <input class="form-control mt-2" id="b_amount" placeholder="Amount" value="0.00000000">
                            </div>
                            <div class="col-3 col-lg-2 mt-2 mt-lg-0">
                                <button class="btn btn-danger btn-block" id="b_send">Send</button>
                            </div>
                        </div>
                    </div>
                </div>

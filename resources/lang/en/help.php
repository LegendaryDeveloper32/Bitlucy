...
return [
    ...
    'block' => [
        'questions' => [
            ...
            'about' => [
                'title' => 'About us',
                'description' => 'Online crypto gambling. We have '.sizeof(\App\Games\Kernel\Game::list()).' games with exciting mechanics and high winning odds.'
            ],
            'how_to_play' => [
                'title' => 'How to play?',
            ...
            'fairness' => [
                'title' => 'Fairness',
                'description' => 'The random number generator creates provable and absolutely honest random numbers, which are used to determine the result of each game played on the site. Each user can check the outcome of any game in a completely deterministic way. By providing one parameter, Client Seed, to the inputs of a random number generator, We cannot manipulate the results in its favor. random number generator allows each game to request any number of random numbers from a given initial client number, initial server number and one-time number. You can learn more about how it works on the fair play page.'
            ],
            'partner' => [
            ...
            'p' => [
                'title' => 'Partnership',
                'description' => 'Contact us: <a href="mailto:support@site.com">support@site.com</a>'
            ]
        ],
        'payments' => [
            'title' => 'Deposit',

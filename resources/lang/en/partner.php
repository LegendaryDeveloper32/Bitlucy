...
return [
    ...
    'overview' => [
        'guest_content' => "<p>Advertise and earn money by participating in our affiliate program!</p>
                      <p>You will receive various bonuses for each active user who will register and play through your link.</p>
                      <button class='btn btn-primary' onclick='$.auth();'>Login</button>",
        'content' => "<p>Advertise Bitlucy.com and earn money by participating in our affiliate program!</p>
                      <p>You will receive various bonuses for each active user who will register and play on  through your link.</p>
                      <strong class='mt-2'>Referral link</strong>
                      <input readonly class='mt-2' style='cursor: pointer !important;' id='link' data-toggle='tooltip' data-placement='top' title='Copy link' value='https://domain.com/?c=:id'>

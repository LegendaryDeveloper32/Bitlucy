...
return [
    'vip' => [
        'description' => '<strong>Weekly VIP Bonus</strong><br>As a member of the VIP program, you are entitled for a weekly VIP bonus. Find out more about this!',
        'unavailable_description' => '<strong>Weekly VIP Bonus</strong><br>All VIP program participants are entitled for a weekly bonus.'
    ],
    'wheel' => [
    ...
    'partner' => [
        'description' => '<strong>Affiliate program</strong><br>Invite your friends to Bitlucy.com and get a bonus!'
    ],
    'rain' => [
    ...
    'notifications' => [
        'description' => '<strong>Notifications</strong><br>Turn on notifications and know about Bitlucy.com updates among the first!'
    ]
];
